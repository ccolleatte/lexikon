		...
		<form class="mt-8 space-y-6" on:submit|preventDefault={handleSubmit}>
			...
			<div class="flex items-center">
				...
				<label for="terms" class="ml-2 block text-sm text-gray-900">
					I agree to the
					<a href="/legal/terms" class="text-primary-600 hover:text-primary-500">Terms of Service</a>
					and
					<a href="/legal/privacy" class="text-primary-600 hover:text-primary-500">Privacy Policy</a>
				</label>
			</div>
